<div class="mx-auto max-w-4xl my-10 rounded-2xl p-3 lg:p-0">
    <x-modal title="Edit Role" blur="sm" wire:model.defer="showModal">
        <x-wui-card rounded="xl" padding="px-10 py-10 space-y-5">
            ...
            <form>
                ...
                <x-slot name="footer" class="flex items-center justify-between">
                    <x-wui-button wire:click="updateRole"  label="Update article" class="bg-secondary" type="submit" />
                    <x-wui-button wire:click="cancle"  outline secondary label="Cancle" class="text-black" type="submit"/>
                </x-slot>
            </form>
        </x-wui-card>
</x-modal>
