<div>
<x-wui-button label="Open" x-on:click="$openModal('cardModal')" primary />
 
 <x-wui-modal-card title="Edit Customer" name="cardModal">
     <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
         ...
         <div
             ...
             <div class="flex flex-col items-center justify-center">
                 <x-wui-icon name="cloud-arrow-up" class="w-16 h-16 text-blue-600 dark:text-teal-600" />
     ...
     <x-slot name="footer" class="flex justify-between gap-x-4">
         ...
         <div class="flex gap-x-4">
             ...
             <x-wui-button primary label="Save" wire:click="save" />
         </div>
     </x-slot>
 </x-wui-modal-card>
</div>
