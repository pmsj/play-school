...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-white text-md font-medium leading-5 text-slate-50 focus:outline-none focus:border-indigo-700 transition duration-150 ease-in-out'
